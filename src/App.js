...
function App() {
  ...
  const apiUrl = useMemo(() => {
    const base = 'https://server.exocal.earth';
  ...
  useEffect(() => {
    const testBackendConnection = async () => {
      const baseUrl = 'https://server.exocal.earth';
        ...
        async function poll() {
          ...
          if (s.state === 'done') {
            ...
            try {
              ...
              a.href = url;
              a.download = `${jobData.job_id}.zip`; // Custom filename with job ID
      ...
      <header className="App-header">
        ...
        <div style={{ display: 'flex', gap: '15px', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <button 
            ...
            onClick={() => window.open('https://github.com/your-username/exocal', '_blank')}
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.boxShadow = '0 0 0 4px rgba(255, 255, 255, 0.15)';
            }}
            onMouseLeave={(e) => {
        ...
        {/* Past Data Visualization Section */}
        <div style={{ 
          marginTop: '40px', 
          display: 'flex', 
          ...
          <div style={{ 
            ...
            <input
              ...
              onKeyPress={(e) => {
                if (e.key === 'Enter') {
                  ...
                  if (jobId) {
                    setJobData({ job_id: jobId, status_url: '', download_url: '' });
                    setShowResults(true);
                  }
                }
              }}
            ...
            <button
              ...
              onClick={() => {
                const input = document.querySelector('input[placeholder="Enter Job ID..."]');
          ...
          <p style={{ 
            ...
            Enter a Job ID from a previous analysis to view its results
          </p>
        </div>
      </header>
